...
$publishDir = $root + "\src\Bucket.Semver\bin\Release\netstandard2.0\publish"
...
dotnet publish src\Bucket.Semver\Bucket.Semver.csproj -c Release /p:Version=$versionNormalized /p:AssemblyVersion=$assemblyVersion /p:FileVersion=$fileVersion --self-contained false
